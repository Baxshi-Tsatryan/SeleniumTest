...
public class AllURLs {
    ...
    public void navigateToStagingPortfolioPage(){
        driver.navigate().to("https://staging.coinstats.app/portfolio");
    }

    public void navigateToDevPortfolioPage(){
        driver.navigate().to("https://dev.coinstats.app/portfolio/");
    }

    public void navigateToDevMainPage(){
        driver.navigate().to("https://dev.coinstats.app/");
    }
