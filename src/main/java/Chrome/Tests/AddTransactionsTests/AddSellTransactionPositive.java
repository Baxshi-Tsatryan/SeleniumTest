...
public class AddSellTransactionPositive extends ChromeDriver {
    ...
    public void addTransactionCase1() throws InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            addTransactions.clickOnSellTab();
            ...
            if (!transactionType.equals("Sell")) {
                System.err.println(coinName + " transaction type is invalid, should be Sell");
            }
