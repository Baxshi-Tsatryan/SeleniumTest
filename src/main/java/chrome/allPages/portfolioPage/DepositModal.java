...
public class DepositModal extends Driver {

    WebDriver driver;
    SeleniumUtils utils;

    public DepositModal(WebDriver driver) {
        this.driver = driver;
    ...
    public DepositModal clickOnPortfolioDropDown() {
    ...
    public DepositModal clickOnCurrentCoin() {
        utils.click(currentCoin);
        return this;
    }

    public DepositModal typeCoinName(String coinName) {
        utils.sendKeys(coinSearchField, coinName);
        return this;
    }

    public DepositModal clearCoinName() {
        utils.clear(coinSearchField);
        return this;
    }

    public DepositModal clickOnFirstCoinResult() {
    ...
    public DepositModal clickOnCopy() {
